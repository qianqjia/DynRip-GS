...
train_base_cmd = (
    "python train_w_dinov2_time_contrib.py -s {} -m {} -r 2 --eval --iteration 15_000 --port 7670"
)
render_base_cmd = "python render_uw_time_contrib.py -m {} --eval -r 2 --port 7670"
metric_base_cmd = "python metrics_qq.py -m {}"
video_base_cmd = "python generate_video_time_contrib.py -m {} --eval --out_path {} --port 7670"
...
for i, folder in enumerate(folders):
    output_folder = os.path.join(
        "/public/home/qianqianjia/experiments/DynRip-GS/BVI-Coras/dino_time_debug",
...
for i, folder in enumerate(folders):
    output_folder = os.path.join(
        "/public/home/qianqianjia/experiments/DynRip-GS/IW/re_dino_time",
        os.path.split(folder)[-1] + "_appdim0",
    )
    train_cmd = train_base_cmd.format(folder, output_folder) + " --appearance_dim 0"
    print(train_cmd)
...
# for i, folder in enumerate(folders):
#     output_folder = os.path.join(
#         "/public/home/qianqianjia/experiments/DynRip-GS/Seathru-metashape/re_dino_time",
#         os.path.split(folder)[-1] + "_appdim0",
#     )
