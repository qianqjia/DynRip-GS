...
class GaussianModel:
    ...
    def __init__(self, 
                 ...
                 uncertainty_config: Config = None
                 ):
    ...
    def training_setup(self, training_args):
        ...
        if self.use_feat_bank:
            l = [
                ...
                {'params': self.uncertainty_model.parameters(), 'lr': training_args.uncertainty_lr, "name": "mlp_uncertainty_model"}
            ]
    ...
    def save_mlp_checkpoints(self, path, mode = 'split'):#split or unite
        ...
        torch.save(
            self.uncertainty_model.state_dict(), os.path.join(path, 'uncertainty_model.pth')
        )
