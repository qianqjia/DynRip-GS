...
#     #     continue
#     output_folder = os.path.join('/public/home/qianqianjia/experiments/DynRip-GS/BVI-Coras/dino-debug3', os.path.split(folder)[-1] + '_appdim0')
...
folders = [f for f in glob.glob(os.path.join(dataset_folder, '*')) if '.' not in os.path.split(f)[-1]]
for folder in folders:
    if 'sardine' not in folder:
        continue
    output_folder = os.path.join('/public/home/qianqianjia/experiments/DynRip-GS/IW/dino-debug3', os.path.split(folder)[-1] + '_appdim0')
    train_cmd = train_base_cmd.format(folder, output_folder) + ' --appearance_dim 0'
    print(train_cmd)
    os.system(train_cmd)
...
# folders = [f for f in glob.glob(os.path.join(dataset_folder, '*')) if '.' not in os.path.split(f)[-1]]
# for folder in folders:
#     output_folder = os.path.join('/public/home/qianqianjia/experiments/DynRip-GS/Seathru-metashape/dino-debug', os.path.split(folder)[-1] + '_appdim0')
#     train_cmd = train_base_cmd.format(folder, output_folder) + ' --appearance_dim 0'
#     print(train_cmd)
#     os.system(train_cmd)
